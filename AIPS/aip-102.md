...
Alice sees that Bob has initiated a transaction, and claims her 3000 NOS, using the secret password (gtMcn7XGlIbq) known only to her. Alice claims the NOS with the blockchain transaction: 
